...
#define TUYA_PRODUCT_ID "oneuysntjkkd7en5"
#endif

#define TUYA_OPENSDK_UUID "uuid"   // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "key" // Please change the correct authkey
